...
/**
 * Astro for teachers: a teaching-assistant chat (lesson plans, quizzes, rubrics…).
 * Reuses the chat pipeline (streaming, persistence, web research) but with the
 * teacher persona and no planet-lesson sources.
 */
class TeacherChatController extends ChatController
{
    public function index(Request $request): View|RedirectResponse
    {
        ...
        return view('student.chat', [
            'chatMode' => 'teacher',
            'messageUrl' => route('teacher.chat.message'),
    ...
    public function send(Request $request): JsonResponse|StreamedResponse
    {
        ...
        $this->nimService = $this->nimService->forPersona('teacher');
