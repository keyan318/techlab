...
<head>
  ...
  <title>Create account · TechLab</title>
  <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('favicon-32x32.png') }}">
  <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('favicon-16x16.png') }}">
  <link rel="apple-touch-icon" href="{{ asset('apple-touch-icon.png') }}">
  <meta name="description" content="Create your TechLab account and start your journey into tech." />
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .card { width: 100%; max-width: 460px; background: var(--glass); border: 1px solid var(--glass-border); border-radius: 24px; padding: 38px 34px; backdrop-filter: blur(14px); box-shadow: 0 30px 80px rgba(6,6,26,.5); }
...
<body>
  ...
  <div class="wrap">
    <div class="card">
      ...
      <h1>Join the <span class="accent">crew</span>.</h1>
      ...
      <form method="POST" action="/register">
        ...
        <div class="field">
          ...
          <input id="name" type="text" name="name" value="{{ old('name') }}" placeholder="Neil Armstrong" required />
        </div>
        <div class="field">
          <label for="email">Email</label>
          <input id="email" type="email" name="email" value="{{ old('email') }}" placeholder="you@galaxy.edu" required />
        </div>
        <div class="field">
        ...
        <button class="btn" type="submit">Create Account <span>→</span></button>
      </form>
  ...
  <script>
    ...
    (function () {
      ...
      let seed = 7711; const rnd = () => { seed = (seed * 1103515245 + 12345) & 0x7fffffff; return seed / 0x7fffffff; };
