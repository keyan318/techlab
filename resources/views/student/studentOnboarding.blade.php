...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* ---------- Onboarding layout ---------- */
    .onboard-wrap { position: relative; z-index: 2; max-width: 1080px; margin: 0 auto; padding: clamp(40px, 7vw, 90px) clamp(20px,5vw,64px) 80px; }
    ...
    .planet-card { position: relative; display: flex; flex-direction: column; gap: 10px; padding: 22px; border-radius: 20px;
    ...
    .join-btn { display: inline-flex; align-items: center; gap: 10px; font-family: 'Space Grotesk', sans-serif; font-weight: 600; font-size: 1.05rem;
      padding: 16px 34px; border-radius: 999px; cursor: pointer; border: none; color: #07142e;
      background: linear-gradient(100deg, var(--cyan), var(--blue) 55%, var(--violet)); box-shadow: 0 10px 40px rgba(115,182,255,.45);
...
<body>
  ...
  <!-- Onboarding: planets + join a crew -->
  <main class="onboard-wrap">
    ...
    <section class="crew-join">
      <a class="join-btn" href="{{ route('student.crew') }}">Join a crew →</a>
      <p>Have a crew code from your teacher or captain? Board your squad's ship to begin.</p>
    </section>
  </main>
