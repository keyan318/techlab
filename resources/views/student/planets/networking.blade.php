...
<head>
  ...
  <title>{{ $course['title'] ?? 'Networking Nebula' }} · TechLab</title>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .space { position: fixed; inset: 0; z-index: -1;
      background:
        radial-gradient(120% 90% at 50% -10%, #0d3a4a 0%, rgba(13,58,74,0) 55%),
        linear-gradient(160deg, #0a0826, #0c1330 45%, #10204a);
    }
    .glow { position: absolute; border-radius: 50%; filter: blur(70px); opacity: .5; }
    .glow.g1 { width: 420px; height: 420px; top: -120px; left: -80px;
      background: radial-gradient(circle, rgba(91,225,255,0.55), transparent 70%); }
    .glow.g2 { width: 480px; height: 480px; bottom: -160px; right: -120px;
      background: radial-gradient(circle, rgba(115,182,255,0.4), transparent 70%); }
