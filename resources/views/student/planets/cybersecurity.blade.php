...
<head>
  ...
  <title>{{ $course['title'] ?? 'Cybersecurity Citadel' }} · TechLab</title>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .space { position: fixed; inset: 0; z-index: -1;
      background:
        radial-gradient(120% 90% at 50% -10%, #2a1452 0%, rgba(42,20,82,0) 55%),
        linear-gradient(160deg, #0a0826, #150c33 45%, #241248);
    }
    .glow { position: absolute; border-radius: 50%; filter: blur(70px); opacity: .5; }
    .glow.g1 { width: 420px; height: 420px; top: -120px; left: -80px;
      background: radial-gradient(circle, rgba(155,107,255,0.6), transparent 70%); }
    .glow.g2 { width: 480px; height: 480px; bottom: -160px; right: -120px;
      background: radial-gradient(circle, rgba(91,225,255,0.4), transparent 70%); }
