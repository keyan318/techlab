...
<div class="lesson-fragment" data-module="m2" data-lesson="03">
    ...
    <div class="cta-wrap relay-lab-cta" data-lab="m2-l3" style="margin-top:1.5rem;">
        <a class="code-btn" href="{{ route('student.planet.lab', ['slug' => 'networking', 'module' => 'm2', 'lesson' => 'lesson03']) }}">
