...
@section('content')
  @if ($crew)
    {{-- MY CLASSES: teacher uploads a schedule (file or photo); Astro organizes it into upcoming classes.
         The old crew-launched hero now lives in teacher/partials/crew-launched.blade.php --}}
    <style>
